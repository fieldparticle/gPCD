...
class A_TABLE_LOGLOG_REGRESS():
    ...
    def run(self):
        ...
        self.Table.append(self.df['aall'])
        self.Table.append(self.df['ball'])
        self.Table.append(self.df['rall'])
        self.Table.append(self.df['asat'])
        self.Table.append(self.df['bsat'])
        self.Table.append(self.df['rsat'])
        self.Table.append(self.df['qa'])
        self.Table.append(self.df['qb'])
        self.Table.append(self.df['qc'])
        self.Table.append(self.df['r'])
