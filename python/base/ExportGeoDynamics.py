...
GENERATED_GLSL = r'''#ifndef GEO_DYNAMICS_GLSL
...
def export_geo_dynamics(output_path=None):
    ...
    output_path.write_text(GENERATED_GLSL, encoding="utf-8", newline="\n")
    return output_path


if __name__ == "__main__":
    print(export_geo_dynamics())
