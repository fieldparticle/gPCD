...
from base.MomentumDynamics import MomentumContactDynamics
...
class MomentumDynamics(MomentumContactDynamics):
    ...
    # and GLSL-coordinate utilities are split out of MomentumDynamicsBase.
    ...
    def CollisionRun(self):
        """Run one complete momentum-dynamics frame."""
    ...
    def BuildFrameSnapshot(self):
        ...
        frame-start state. This keeps contact detection and impulse planning
        based on one consistent moment rather than on partially updated
        particle state.
        """
    ...
    # access helpers are split out of MomentumDynamicsBase.
    ...
    @staticmethod
    ##JMB Future common helper: move to ShadowCommon.py when shared geometry
    # utilities are split out of MomentumDynamicsBase.
    ...
    def DetectContacts(self):
        """Run naive contact detection and momentum dynamics for every source."""
    ...
    def MoveParticles(self):
        """Move every particle using the momentum per-particle move function."""
