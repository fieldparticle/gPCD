"""Generate the current MomentumDynamics function flowchart.

This chart shows only the flow inside MomentumDynamics.py. At this stage the
...
DOT_FILE = OUTPUT_DIR / "MomentumDynamicsFlow.dot"

MOMENTUM_DYNAMICS = REPO_DIR / "python" / "base" / "MomentumDynamics.py"
SOURCE_DOCUMENTATION = DOC_DIR / "SourceDocumentation.tex"

NODE_SOURCES = {
    node_id: MOMENTUM_DYNAMICS
    for node_id in (
        "ContactDynamics",
        ...
        "GetContactSlots",
        "GetCollisionPhase",
        "GetCollisionInternalMomentum",
        "CalculateContactParms",
        "GetStartFrameVelocity",
        "GetReducedMass",
        "CalculateContactImpulse",
        "GetPairStiffness",
        "ApplySourceMomentumDelta",
        "GetParticleMass",
        "UpdateContactLedgers",
        "SetCollisionInternalMomentum",
        "SetCollisionPhase",
        "SyncInternalMomentum",
        "GetInternalMomentum",
        "SetInternalMomentum",
    )
}
...
def build_dot() -> str:
    ...
    edges = [
        ...
        dot_edge("CalculateContactParms", "CalculateContactImpulse"),
        dot_edge("CalculateContactImpulse", "GetPairStiffness"),
        dot_edge("GetPairStiffness", "CalculateContactImpulse"),
        dot_edge("CalculateContactImpulse", "InitializeContactState", "next contact"),
        dot_edge("CalculateContactImpulse", "ApplySourceMomentumDelta", "all contacts done"),
        dot_edge("ApplySourceMomentumDelta", "GetParticleMass"),
        dot_edge("GetParticleMass", "ApplySourceMomentumDelta"),
        dot_edge("ApplySourceMomentumDelta", "UpdateContactLedgers"),
    ...
    lines.extend(
        [
            ...
            dot_node("CalculateContactImpulse", "CalculateContactImpulse", "box", action),
            dot_node("GetPairStiffness", "GetPairStiffness", "box", action),
            dot_node("ApplySourceMomentumDelta", "ApplySourceMomentumDelta", "box", action),
