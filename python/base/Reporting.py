        ...
        with csv_path.open("a", newline="", encoding="utf-8") as csv_file:
            ...
            writer.writerow(
                [
                    ...
                    self.csv_number(momentum_summary["internal_px"]),
                    self.csv_number(momentum_summary["internal_py"]),
                    self.csv_number(momentum_summary["internal_pz"]),
        ...
        with csv_path.open("a", newline="", encoding="utf-8") as csv_file:
            ...
            writer.writerow(
                [
                    ...
                    self.csv_number(getattr(getattr(particle, "parms", object()), "y", 0.0)),
                    self.csv_number(getattr(getattr(particle, "parms", object()), "z", 0.0)),
                    self.csv_number(getattr(getattr(particle, "parms", object()), "w", 0.0)),
                ...
                for slot, contact in contacts:
                    ...
                    writer.writerow(
                        [
                            ...
                            self.csv_number(getattr(contact, "internal_momentum_py", 0.0)),
