"""Generate the current WeightedDynamics function flowchart.

This chart shows only the flow inside WeightedDynamics.py.  At this stage the
...
DOT_FILE = OUTPUT_DIR / "WeightedDynamicsFlow.dot"

WEIGHTED_DYNAMICS = REPO_DIR / "python" / "base" / "WeightedDynamics.py"
SOURCE_DOCUMENTATION = DOC_DIR / "SourceDocumentation.tex"

NODE_SOURCES = {
    "ContactDynamics": WEIGHTED_DYNAMICS,
    "BeginSourceContactParms": WEIGHTED_DYNAMICS,
    "InitializeContactState": WEIGHTED_DYNAMICS,
    "GetContactState": WEIGHTED_DYNAMICS,
    "GetParticleGeometry": WEIGHTED_DYNAMICS,
    "GetParticlePosition": WEIGHTED_DYNAMICS,
    "AppendContactSlot": WEIGHTED_DYNAMICS,
    "GetContactSlots": WEIGHTED_DYNAMICS,
    "GetCollisionPhase": WEIGHTED_DYNAMICS,
    "GetCollisionInternalMomentum": WEIGHTED_DYNAMICS,
    "CalculateContactParms": WEIGHTED_DYNAMICS,
    "GetStartFrameVelocity": WEIGHTED_DYNAMICS,
    "GetReducedMass": WEIGHTED_DYNAMICS,
    "CalculateContactWeights": WEIGHTED_DYNAMICS,
    "CalculateContactImpulses": WEIGHTED_DYNAMICS,
    "GetPairStiffness": WEIGHTED_DYNAMICS,
    "ApplySourceVelocityDelta": WEIGHTED_DYNAMICS,
    "GetParticleMass": WEIGHTED_DYNAMICS,
    "UpdateContactLedgers": WEIGHTED_DYNAMICS,
    "SetCollisionInternalMomentum": WEIGHTED_DYNAMICS,
    "SetCollisionPhase": WEIGHTED_DYNAMICS,
    "SyncInternalMomentum": WEIGHTED_DYNAMICS,
    "GetInternalMomentum": WEIGHTED_DYNAMICS,
    "SetInternalMomentum": WEIGHTED_DYNAMICS,
}
...
def node_url(node_id: str) -> str | None:
    if node_id not in NODE_SOURCES:
        return None
    section_text = f"\\WeightedFunctionSection{{{node_id}}}"
