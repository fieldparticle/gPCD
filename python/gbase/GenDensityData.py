...
class GenDensityData(GenDataBase):
    ...
    def calculate_test_properties(self):
        try :
           #print(self.index)
            ...
            self.side_length            = int(self.select_list[self.index]["side_len"])
        ...
        self.number_particles           = int(((self.side_length-1)**3)*self.particles_in_cell)
        self.tot_num_cells              = int(self.number_particles / self.particles_in_cell)
        self.num_collisions_per_cell    = 0
    ...
    def gen_data_base(self,index,progress_callback=None):
        ...
        self.bin_count = count_all_particle_data(self.test_bin_name)
        ...
        self.log.log(self,f"Expected Particles: {self.number_particles} ,Total Particles: {self.particle_count},Calculated Collisions:{self.tot_num_collsions}, Counted Collsions:{self.collision_count}")
        self.log.log(self,f"Counted Binary Particles: {self.bin_count}")
        self.log.log(self,f"pp cell {self.particles_in_cell}, pp row: {self.particles_in_row},pp col: {self.particles_in_col},pp layer:{self.particles_in_layers}")
        self.log.log(self,"=========================================================\n")
        return ret    
