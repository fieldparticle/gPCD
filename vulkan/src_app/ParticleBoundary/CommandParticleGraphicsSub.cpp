...
void CommandParticleGraphicsSub::RecordSubPassCube(uint32_t imageindex, uint32_t currentBuffer)
{
...
void CommandParticleGraphicsSub::RecordSubPassParticle(uint32_t imageindex, uint32_t currentBuffer)
{
