...
%*
%******************************************************************/
#ifndef RESOURCECONTBOUND_HPP
#define RESOURCECONTBOUND_HPP

class Resource;
class VulkanObj;
class ResourceContainerBoundary : public ResourceContainerObj
{

public:
	
	ResourceContainerBoundary(VulkanObj* App, std::string Name,
