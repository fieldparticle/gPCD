...
%*
%******************************************************************/
#ifndef RESOURCESPHERECONT_HPP
#define RESOURCESPHERECONT_HPP

class Resource;
class VulkanObj;
class ResourceSphereContainer : public ResourceContainerObj
{

public:
	
	ResourceSphereContainer(VulkanObj* App, std::string Name,
