...
#define COMMANDPARTICLEGRAPHICSSUB_HPP

class CommandParticleGraphicsSub : public CommandObj
{
public:
	...
	CommandParticleGraphicsSub(VulkanObj* App, std::string Name) : CommandObj(App, Name){};
