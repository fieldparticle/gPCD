...
%*
%******************************************************************/
#ifndef COMMANDPARTICLEBOUNDARYONLY_HPP
#define COMMANDPARTICLEBOUNDARYONLY_HPP

class CommandParticleBoundaryOnly : public CommandObj
{
public:
	...
	CommandParticleBoundaryOnly(VulkanObj* App, std::string Name) : CommandObj(App, Name){};
