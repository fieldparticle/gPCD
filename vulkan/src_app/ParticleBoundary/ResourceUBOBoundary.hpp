...
%*
%******************************************************************/
#ifndef RESOURCEBOUNDARYUBO_HPP
#define RESOURCEBOUNDARYUBO_HPP

class ResourceVertexParticle;
class ResourceBoundaryUBO : public Resource
{
...
public:
	...
	bool InitFlag = false;
	ResourceBoundaryUBO(VulkanObj* App, std::string Name) : 
