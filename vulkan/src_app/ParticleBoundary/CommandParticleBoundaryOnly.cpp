...
void CommandParticleBoundaryOnly::Create(SwapChainObj* SCO,
	FrameBufferObj* FBO,
	RenderPassObj* RPO,
...
void CommandParticleBoundaryOnly::RecordCommands(uint32_t imageindex, uint32_t currentBuffer)
{
...
void CommandParticleBoundaryOnly::RecordSubPassCube(uint32_t imageindex, uint32_t currentBuffer)
{
...
void CommandParticleBoundaryOnly::RecordSubPassParticle(uint32_t imageindex, uint32_t currentBuffer)
{
