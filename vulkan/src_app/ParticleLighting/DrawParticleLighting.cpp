...
///FIXX THIS
void DrawParticleLighting::Create(CommandPoolObj* CPL,
	SwapChainObj* SCO,
	RenderPassObj* RPO,
	FrameBufferObj* FBO,
	SyncObj* SO,
...
void DrawParticleLighting::DrawFrame()
{
	VkResult ret;
...
void DrawParticleLighting::SaveImage(uint32_t ImgNum)
{
...
*/
VkCommandBuffer DrawParticleLighting::createCommandBuffer(VkCommandBufferLevel level, VkCommandPool pool, bool begin)
{
...
VkCommandBuffer DrawParticleLighting::createCommandBuffer(VkCommandBufferLevel level, bool begin)
{
	return createCommandBuffer(level, m_CPL->m_CommandPool, begin);
}

void  DrawParticleLighting::insertImageMemoryBarrier(
	VkCommandBuffer cmdbuffer,
	VkImage image,
...
*/
void DrawParticleLighting::flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, VkCommandPool pool, bool free)
{
...
void DrawParticleLighting::flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, bool free)
{
	return flushCommandBuffer(commandBuffer, queue, m_CPL->m_CommandPool, free);
}
uint32_t DrawParticleLighting::getMemoryType(uint32_t typeBits, VkMemoryPropertyFlags properties, VkBool32 *memTypeFound)
{
