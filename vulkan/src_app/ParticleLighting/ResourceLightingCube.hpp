...
%*
%******************************************************************/
#ifndef ResourceLightingCube_HPP
#define ResourceLightingCube_HPP

class ResourceVertexParticle;
class ResourceLightingCube : public ResourceVertexObj
{
      public:
		virtual void AskObject(uint32_t AnyNumber) {};
		ResourceLightingCube(VulkanObj* App, std::string Name) :
