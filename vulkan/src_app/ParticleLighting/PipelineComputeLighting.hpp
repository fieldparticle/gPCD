...
#ifndef PIPLINECOMPUTELIGHTING_HPP
#define PIPLINECOMPUTELIGHTING_HPP
class PipelineComputeLighting : public PipelineObj
{
    public:
		
		PipelineComputeLighting(VulkanObj* App, std::string Name):
