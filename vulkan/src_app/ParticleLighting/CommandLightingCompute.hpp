...
%*
%******************************************************************/
#ifndef COMMANDPOOLLIGHTINGCOMPUTE_HPP
#define COMMANDPOOLLIGHTINGCOMPUTE_HPP

class CommandLightingCompute : public CommandObj
{


public:
	virtual void RecordCommands( uint32_t imageIndex, uint32_t currentBuffer);
	CommandLightingCompute(VulkanObj* App, std::string Name) : CommandObj(App, Name){};
