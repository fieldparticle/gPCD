...
void PipelineComputeLighting::CreatePipeline()
{

    std::string t_cshader_spv   = "application.comp_kernParticlespv";
    std::string t_cshader_glsl  = "application.comp_kernParticle";
