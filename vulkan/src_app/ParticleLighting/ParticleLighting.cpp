...
int ParticleLighting(PerfObj* perObj, TCPObj* tcp, TCPObj* tcpapp, bool rmtFlag)
{
	...
	CommandLightingGraphics* commandParticleGraphics
			= new  CommandLightingGraphics(vulkanObj, "CommandLightingGraphics");
	...
	PipelineGraphicsLighting* pipelineGraphicsParticle
		= new PipelineGraphicsLighting(vulkanObj, "Graphics Pipeline Lighting");
	...
	DrawParticleLighting* drawParticleLighting = new DrawParticleLighting(vulkanObj, "Draw Particle Lighting");
	...
	drawParticleLighting->Create(commandPool, swapChain, renderPass, frameBuffer, syncObjects, exportObject);
	...
	ret = Loop(perObj, tcp,tcpapp, drawParticleLighting,vulkanObj, resourceGraphicsContainer, resourceComputeContainer);
