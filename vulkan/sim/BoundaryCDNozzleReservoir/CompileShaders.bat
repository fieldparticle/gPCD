...
cd %~dp0\
set dir_name=%1
set src=C:\_DJ\gPCD\vulkan\sim\%dir_name%\%dir_name%.vert
set dst=vertb.spv
...
set src=C:\_DJ\gPCD\vulkan\sim\%dir_name%\%dir_name%.frag
set dst=fragb.spv
...
set src=C:\_DJ\gPCD\vulkan\sim\%dir_name%\%dir_name%P.frag
set dst=frag.spv
echo Compiling frag shader %src% to %dst%
	C:\_DJ\gPCD\vulkan\shaders\glslc.exe --target-env=vulkan1.3 -g %src% -o  %dst% >> frg.log
	IF %ERRORLEVEL% NEQ 0 ( 
...
set src=C:\_DJ\gPCD\vulkan\sim\%dir_name%\%dir_name%P.vert
set dst=vert.spv
echo Compiling frag shader %src% to %dst%
	C:\_DJ\gPCD\vulkan\shaders\glslc.exe --target-env=vulkan1.3 -g %src% -o  %dst% >> frg.log
	IF %ERRORLEVEL% NEQ 0 ( 
...
set src=C:\_DJ\gPCD\vulkan\sim\%dir_name%\%dir_name%P.comp
set dst=comp.spv
echo Compiling frag shader %src% to %dst%
	C:\_DJ\gPCD\vulkan\shaders\glslc.exe --target-env=vulkan1.3 -g %src% -o  %dst% >> frg.log
	IF %ERRORLEVEL% NEQ 0 ( 
