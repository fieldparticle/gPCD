...
const LightingSurfaceObjectMetadata LIGHTING_SURFACE_OBJECTS[3] = LightingSurfaceObjectMetadata[3](
    ...
    LightingSurfaceObjectMetadata(1u, 1000u, 1u, 13122u, 8320u, 48384u, 64u, 128u, vec4(0.000000000, 0.000000000, 0.000000000, 1.000000000), 0.000000000)
);
...
const uint LIGHTING_SPHERE_DECAL_MAP_SURFACE_ID = 1000u;
const uint LIGHTING_SPHERE_DECAL_MAP_COUNT = 35u;
const uvec4 LIGHTING_SPHERE_DECAL_MAP_CELLS[35] = uvec4[35](
    uvec4(33u, 50u, 7u, 0u),
    uvec4(33u, 51u, 7u, 0u),
    uvec4(34u, 50u, 7u, 0u),
    uvec4(34u, 51u, 7u, 0u),
...
const vec4 LIGHTING_SPHERE_DECAL_MAP_ALBEDOS[35] = vec4[35](
    vec4(0.000000000, 0.000000000, 1.000000000, 1.000000000),
    vec4(0.000000000, 0.000000000, 1.000000000, 1.000000000),
    vec4(0.000000000, 0.000000000, 1.000000000, 1.000000000),
    vec4(0.000000000, 0.000000000, 1.000000000, 1.000000000),
    vec4(0.000000000, 0.000000000, 1.000000000, 1.000000000),
