...
set src=C:\_DJ\gPCD\vulkan\sim\BoundaryCube\BoundaryCube.vert
set dst=vertb.spv
...
set src=C:\_DJ\gPCD\vulkan\sim\BoundaryCube\BoundaryCube.frag
set dst=fragb.spv
...
set src=C:\_DJ\gPCD\vulkan\sim\BoundaryCube\BoundaryCubeP.frag
set dst=frag.spv
echo Compiling frag shader %src% to %dst%
	C:\_DJ\gPCD\vulkan\shaders\glslc.exe --target-env=vulkan1.3 -g %src% -o  %dst% >> frg.log
	IF %ERRORLEVEL% NEQ 0 ( 
...
set src=C:\_DJ\gPCD\vulkan\sim\BoundaryCube\BoundaryCubeP.vert
set dst=vert.spv
echo Compiling frag shader %src% to %dst%
	C:\_DJ\gPCD\vulkan\shaders\glslc.exe --target-env=vulkan1.3 -g %src% -o  %dst% >> frg.log
	IF %ERRORLEVEL% NEQ 0 ( 
...
set src=C:\_DJ\gPCD\vulkan\sim\BoundaryCube\BoundaryCubeP.comp
set dst=comp.spv
echo Compiling frag shader %src% to %dst%
	C:\_DJ\gPCD\vulkan\shaders\glslc.exe --target-env=vulkan1.3 -g %src% -o  %dst% >> frg.log
	IF %ERRORLEVEL% NEQ 0 ( 
