...
const uint bbound =922;
const float point_size = 3.00;
#define PHOTON_PERIODIC_RECYCLE_ENABLED 0u
#define FORCE_DYNAMICS_SIMPLE_COMPRESSION_STIFFNESS_GAIN 6.000000000
