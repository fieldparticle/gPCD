    ...
    def calculate_collision_acceleration(self,pnum):
        ...
        for cc in self.pary[pnum].collision_list:
            ...
            if cc.col_flag == True:
                ...
                cc.v_coll = cc.pen_factor*cc.v_rel
                ...
                self.pary[pnum].internal_mom = np.linalg.norm([cc.tot_collision_x_acc,
                                                                 cc.tot_collision_y_acc])
                
                self.pary[pnum].internal_momx = cc.tot_collision_x_acc
                self.pary[pnum].internal_momy = cc.tot_collision_y_acc
