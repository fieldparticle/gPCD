...
class Demo:
    ...
    def draw_report(self):
        ...
        summary_lines = (
            f"overlap_momentum start={self.start_overlap_momentum:.3e} end={current_overlap_momentum:.3e}",
            f"ke               start={self.start_kinetic_energy:.3e} end={current_kinetic_energy:.3e}",
        )
