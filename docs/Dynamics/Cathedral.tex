...
Photon-wall interaction remains active.  The photon-photon skip applies only
to particle-particle pairs whose source and target are both photon material
types; wall and boundary-marker paths are not disabled by the photon rule.
