...
\begin{enumerate}
    ...
    \item Capture report files, named \texttt{CapXXXXXX.rpt}, are written to \texttt{C:\textbackslash\_DJ\textbackslash gPCDData\textbackslash examples}.
    ...
    \]
    for particle-particle contacts. For wall contacts, the particle mass is used in place of reduced mass.
    ...
    \item Particle-particle and wall contacts can share one contact-state structure. The contact type distinguishes particle contacts from wall contacts.
