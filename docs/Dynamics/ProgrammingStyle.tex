...
For weighted dynamics work, the sequential stage chain should be
...
The current weighted source-flow generator is:
...
The permanent weighted implementation demonstrates the preferred shape for dynamics
