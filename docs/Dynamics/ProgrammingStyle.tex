...
SVG can carry interactive source links, and the PDF is used as the stable LaTeX
figure.  The generator should be updated when function names, stage order, or
major source handoffs change.
