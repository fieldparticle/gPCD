...
loop.  \texttt{WeightedDynamics} completes source contact slots before
applying contact dynamics.  \texttt{ForceDynamics} immediately accumulates
each detected particle or wall force into \texttt{totalForce}; its contact
slots are diagnostic only.
