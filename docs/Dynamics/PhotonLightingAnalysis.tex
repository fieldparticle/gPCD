...
contact deposits incidence-weighted RGB-band spectral color into the spatial
cell containing the analytic hit point, and the lighting surface fragment
shader reads that cell-owned color.
...
direction is to keep \texttt{BoundaryLightRecord.rgb\_valid} as the final
visible cell color while learning which transport behaviors require additional
Vulkan tables.
