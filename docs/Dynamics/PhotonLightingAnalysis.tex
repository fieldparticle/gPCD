...
\begin{itemize}
    ...
    \item photon \texttt{material\_id} is temporarily changed to the contacted
          surface material for diagnostics and future boundary lighting.
\end{itemize}

This is useful for debugging whether photons hit the correct surface and
whether the material color source is being read correctly.  The cleaned
Python renderer treats \texttt{LUMENS} as debug photon visibility only, so it
does not yet make the sphere or walls look illuminated.
