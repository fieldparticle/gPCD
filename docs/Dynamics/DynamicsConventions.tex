...
Current force depends on current frame-start positions, radii, pair stiffness,
overlap area, and contact normal.  Relative velocity is diagnostic only and
does not affect force magnitude.  Only particle physical state, including
position and velocity, persists into the next frame.
