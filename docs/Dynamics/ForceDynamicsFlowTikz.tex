...
\node[function, below=0.20in of main] (start-state)
    {\ForceFlowNode{InitializeStartingContactState}{InitializeStartingContactState}};
...
\node[function, below=of init] (state)
    {\ForceFlowNode{GetContactState}{GetContactState}};
\node[function, below=of state] (append)
    {\ForceFlowNode{AppendContactSlot}{AppendContactSlot}};
...
\node[reused, right=0.18in of append] (append-slots)
    {\ForceFlowNode{GetContactSlots}{GetContactSlots}};
\node[reused, right=0.18in of geometry] (geometry-position)
    {\ForceFlowNode{GetParticlePosition}{GetParticlePosition}};
\node[reused, right=0.18in of geometry-position] (geometry-effective)
    {\ForceFlowNode{GetParticleEffectiveContactGeometry}{GetParticleEffectiveContactGeometry}};
...
\draw[reusecall] (geometry-position) -- (geometry-effective);
