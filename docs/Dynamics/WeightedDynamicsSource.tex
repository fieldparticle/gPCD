...
This source-local allocation limits compression only.  It does not multiply
the physical pair impulse.
...
The current raw pair impulse is:
...
Current \texttt{ThreeParticle} diagnostics show exact vector momentum but
approximately \(-0.00020547\) kinetic-energy drift after the contact ledgers
drain.
