...
\texttt{ForceDynamics} processes one source particle completely before
...
\caption{Current ForceDynamics function flow}
\end{figure}
...
\ForceFunctionSection{GetCollisionPhase}
...
\ForceFunctionSection{GetCollisionInternalMomentum}
...
\ForceFunctionSection{GetReducedMass}
...
\ForceFunctionSection{CalculateContactWeights}
...
\ForceFunctionSection{CalculateContactImpulses}
...
\ForceFunctionSection{UpdateContactLedgers}
...
\ForceFunctionSection{SetCollisionInternalMomentum}
...
\ForceFunctionSection{SetCollisionPhase}
...
\ForceFunctionSection{SyncInternalMomentum}
...
\ForceFunctionSection{GetInternalMomentum}
...
\ForceFunctionSection{SetInternalMomentum}
...
\ForceFunctionSection{isValidParticleID}
