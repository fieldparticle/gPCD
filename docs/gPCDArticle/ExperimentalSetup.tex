...
\bell{add}{gpcd is an exact collision detection method.tests are run in verification mode first to verify particle and collision counts and then in performance mode to measure peerformance}
