...
This cost is independent of the total number of allocated cells because
occupancy generation is particle-driven: empty cells are not traversed
during broad-phase construction.
