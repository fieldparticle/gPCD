...
particle interactions. In addition to their role in direct physical
simulation, particle methods provide high-fidelity datasets that can be
used for model development, validation, and the training of
data-driven and machine-learning approaches. Consequently, particle
simulation is expected to remain an important tool for both scientific
discovery and the generation of representative physical data.

Despite their broad applicability, the practical use of particle
methods is often constrained by computational cost. As simulation
fidelity increases, the number of particles required to accurately
represent physical systems may grow into the millions or billions.
Higher particle counts enable finer spatial resolution and improved
physical fidelity. However, these benefits come at the cost of
...
throughput and memory bandwidth and are widely used for 
