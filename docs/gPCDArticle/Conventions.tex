...
2. Background and Related Work
    ...
    2.2 Rendering and Collision Detection
        How have rendering and collision detection traditionally
        been organized?

    2.3 Gap in Existing Methods
...
3. Methodology
    ...
    3.3 Corner-Based Occupancy Construction
        How are corners used to populate cells?

    3.4 Cell Addressing and Flattening
        How are cells identified and accessed?

    3.5 PCS Construction
        How is the potentially colliding set formed?

    3.6 Narrow-Phase Evaluation
...
4. Complexity Analysis
    ...
    4.1 Occupancy Generation
        Cost of broad-phase occupancy generation.

    4.2 Narrow-Phase Evaluation
        Cost of collision evaluation.

    4.3 Storage Requirements
        Memory requirements of the architecture.
...
5. Experimental Setup
    ...
    5.3 Benchmark Datasets
        Particle counts and benchmark-density figures.
...
7. Discussion
    ...
    7.1 Interpretation of Scaling
        Meaning of measured scaling.

    7.2 Saturation Behavior
        GPU saturation and throughput limits.

    7.3 Comparison to Prior Work
        Relative performance and architectural differences.
