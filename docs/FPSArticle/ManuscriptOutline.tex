...
=========================================================
    ...
    Philosophical motivation.
        ...
        - Introduce the author's view that physical
          interactions occur only at the present
          instant.

        - Discuss the distinction between locally
          accessible quantities and observer-derived
          quantities.

        - Motivate the use of present-state dynamics.
...
=========================================================
	...
	- Introduce the present-state assumption and the
  		restriction of governing dynamics to locally
  		accessible quantities.

	- Distinguish between governing quantities and
  		observer-derived quantities.

	- Discuss the role of force, momentum, and geometry
  		as locally accessible quantities.

	- Discuss energy, work, and other integrated
  		quantities as diagnostic quantities.
...
=========================================================
Section: Discussion Philosophical Interpretation
=========================================================

    Subject:
        Philosophical interpretation and motivation of
        the FPS framework.

    Purpose:
        Distinguish the author's philosophical
        motivations from the scientific assumptions and
        computational methodology of FPS.

    Paragraph Subjects:

        - Discuss the author's present-state view of
          physical interactions.

        - Discuss the distinction between locally
          accessible and observer-derived quantities.

        - Discuss the interpretation of past and future
          as observer constructions arising from memory
          and prediction.

        - Discuss energy as a diagnostic quantity and
          ledger of system evolution.

        - Discuss the relationship between the
          philosophical assumptions and the FPS
          methodology.

        - Emphasize that FPS does not prove these
          philosophical positions but investigates the
          consequences of adopting them within a
          particle dynamics framework.
...
=========================================================
    ...
    Paragraph Subjects:
		...
		- Discuss the relationship between the author's
  			philosophical motivation and the resulting FPS
  			methodology.

		- Discuss the possibility that locally accessible
  			present-state quantities may be sufficient to
