...
=========================================================
    ...
    Subject:
        ...
        methodology including particle representation,
        force generation, state evolution, and source-
        owned execution.

    Purpose:
        Present the complete FPS methodology and describe
        how particle geometry, contact interactions,
        force evaluation, and numerical integration are
        combined to evolve the system through time.
    ...
    Paragraph Subjects:
        ...
        - Define potential-energy evaluation and its role
          within the framework.

        - Define source acceleration accumulation from
          contact contributions.

        - Describe the velocity-Verlet integration
          procedure.

        - Describe the frame-start and predicted-position
          snapshots used during force evaluation.

        - Describe position prediction and velocity
          update procedures.
        ...
        - Discuss computational properties of the
          methodology including symmetry, conservation,
